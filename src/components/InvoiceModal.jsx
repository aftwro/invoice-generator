      ...
      .then((dataUrl) => {
        ...
        img.onload = () => {
          ...
          for (let page = 0; page < nPages; page++) {
            ...
            const imgData = pageCanvas.toDataURL(`image/AED {imageType}`, 1);
            pdf.addImage(imgData, imageType, 0, 0, pdfWidth, pageHeight);
          }
          // Output / Save
          pdf.save(`invoice-AED {invoiceInfo.invoiceNumber}.pdf`);
        };
      })
      .catch((error) => {
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-4 flex flex-col items-end space-y-2">
                    <div className="flex w-full justify-between border-t border-black/10 pt-2">
                      ...
                      <span>AED {invoiceInfo.subtotal.toFixed(2)}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Discount:</span>
                      <span>AED {invoiceInfo.discountRate.toFixed(2)}</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Tax:</span>
                      <span>AED {invoiceInfo.taxRate.toFixed(2)}</span>
                    </div>
